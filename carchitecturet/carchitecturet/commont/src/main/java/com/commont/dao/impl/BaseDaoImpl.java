...
import com.commont.dao.BaseDao;
import com.commont.model.Entity;
import com.commont.model.Entity.Criteria;
import com.commont.model.Entity.PrimaryKey;
import com.commont.model.Entity.SimpleCriteria;
...
public class BaseDaoImpl<K extends Serializable, E extends Entity> implements BaseDao<K, E> {
	...
	protected String statement(String id) {
		return String.format("com.commont.dao.%sDao.%s", entityClass.getSimpleName(), id);
	}
