        ...
        <div class="header">
            <div class="container">
                ...
                <ul class="nav">
                    ...
                    <li><a class="active" href="./applet.jsp">小程序开发<span></span></a></li>
    ...
    <div>
        ...
        <div class="applet-dev">
            ...
            <ul class="advantage-list container clearfix">
                <li>
                    <div class="img"></div>
                    <h3 class="text">便于任意分享</h3>
                </li>
                <li>
                    <div class="img"></div>
                    <h3 class="text">扫一扫即可使用</h3>
                </li>
                <li>
                    <div class="img"></div>
                    <h3 class="text">更好的用户体验</h3>
                </li>
            </ul>
            <div class="usagescenario">
                <div class="usagescenario-title  container">
                    <h3>无论你是哪个行业哪种使用场景</h3>
                    <p>总有一套适合你的这你解决方案</p>
                </div>
                <ul class="usagescenario-list  container clearfix">
                    <li>
                        <p class="icon"></p>
                        <h3>生活服务类</h3>
                    </li>
            ...
            <ul class="custom-list container clearfix">
                <li>
                    <p class="icon"></p>
                    <p class="text">客户本地系统整合 CRM,CMS,ERP等系统数据 整合</p>
                </li>
                <li>
                    <p class="icon"></p>
                    <p class="text">品牌形象设计 根据行业特征及企业定位设计品牌形象 CRM,CMS,ERP等系统数据</p>
                </li>
                <li>
                    <p class="icon"></p>
                    <p class="text">功能模块开发 房产，展会，餐饮，商圈等不同行业的深度开发</p>
                </li>
                <li>
                    <p class="icon"></p>
                    <p class="text">更多开发服务 基于微信平台的一切开发服务</p>
                </li>
            </ul>
        </div>
    </div>
