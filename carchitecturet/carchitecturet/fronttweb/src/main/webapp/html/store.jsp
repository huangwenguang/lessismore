...
<body>
        ...
        <div class="header">
            <div class="container">
                ...
                <ul class="nav">
                    ...
                    <li><a class="active" href="./store.jsp">商城开发<span></span></a></li>
    ...
    <div>
        ...
        <div class="store-dev">
            ...
            <div class="store-introduce container">
                <div class="introduce-text">
                    <p>购物商城就是指提供网上购物的网络平台，而这种平台主要是指网上购物网站。消费者可以在网上寻找自己想要的商品，然后进行网上购买，网上支付，最后通过快递运输并拿到自己所需的东西</p>
                    <p>广州市少即多科技有限公司为了满足中大型企业搭建多用户共存的商城平台，提供完善的服务，全方位把控，帮助企业和个人迅速搭建属于自己的商城，打通线上线下渠道，跨屏多终端搞笑互动提高交易量，少即多根据客户的需求为企业打造强大的商城系统。</p>
                </div>
            ...
            <div class="coreadvantage container clearfix">
                <ul class="coreadvantage-list clearfix">
                    <li>
                        <p>创意设计+科技艺术</p>
                        <p>打造精品网站</p>
                        <ul class="list-ls clearfix">
                            <li>网站创意设计<i></i></li>
                            <li>网页布局设计<i></i></li>
                            <li>网页设计的色彩处理<i></i></li>
                            <li>网站设计的动画效果<i></i></li>
                ...
                <ul class="odd fl clearfix">
                    ...
                    <li>
                        <p>联合运营</p>
                        <ul class="list-ls clearfix">
                            <li>市场分析有效帮助客户进行良好的规划、量身打造有价值的网站，提高品牌影响力。<i></i></li>
                        </ul>
                    </li>
                    <li>
                        <p>跟进服务</p>
                    ...
                    <li>
                        <p>交互原型设计</p>
                        <ul class="list-ls clearfix">
                            <li>头脑风暴交互情景模拟、原型设计。<i></i></li>
                            <li>设计适合人操作习惯的交互操作。<i></i></li>
                        </ul>
                    </li>
                </ul>
                <div class="store-ng">
                </div>
                <ul class="even fr clearfix">
                    <li>
                        <p>市场调研 策划方案</p>
                        <ul class="list-ls clearfix">
                            <li>根据市场调研、策划方案、数据分析、提供创意策划，新 颖的软件开发解决方案，致力于客户提供有价值的品牌策划 服务
                                <i></i></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>高端网站定制开发</p>
                        <ul class="list-ls clearfix">
                            <li>定制高端的网站、优良的品牌形象<i></i></li>
                        </ul>
                    </li>
                    <li>
                        <p>用心服务</p>
                        <ul class="list-ls clearfix">
                            <li>成熟的技术、卓越的品质、专业的服务、受到了广大客户 的信赖
                                <i></i></li>
                        </ul>
                    </li>
                </ul>
