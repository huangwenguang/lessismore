...
<body>
        ...
        <div class="header">
            <div class="container">
                ...
                <ul class="nav">
                    ...
                    <li><a href="./appdev.html">APP开发<span></span></a></li>
                    <li><a href="./store.html">商城开发<span></span></a></li>
                    <li><a href="./game.html">游戏开发<span></span></a></li>
                    <li><a href="./applet.html">小程序开发<span></span></a></li>
                    <li><a href="./iot.html">物联网<span></span></a></li>
                    <li><a href="./smarthome.html">智能家居开发<span></span></a></li>
                    <li><a href="./contactus.html">联系我们<span></span></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="h5-dev">
            ...
            <div class="h5-introduce container">
                <div class="introduce-text">
                    <p>H5的最显著的优势在于跨平台性，用H5搭建的站点与应用可以兼容PC端与移动端、Windows与Linux、安卓与IOS。它可以轻易地移植到各种不同的开放平台、应用平台上，打破各自为政的局面。这种强大的兼容性可以显著地降低开发与运营成本，可以让企业特别是创业者获得更多的发展机遇。</p>
                    <p>H5之所以能引发如此广泛的效应，根本在于它不再只是一种标记语言，它为下一代互联网提供了全新的框架和平台，包括提供免费插件的音视频、图像动画、本体存储以及更多酷炫而且重要的功能，并使这些应用标准化和开发化，从而使互联网也能轻松实现类似桌面的应用体验</p>
                </div>
        ...
        <div class="merit clearfix">
            ...
            <ul class="advantage-list container clearfix">
                <li>
                    <div class="img"></div>
                    <h3 class="text">提升企业营业额</h3>
                </li>
                <li>
                    <div class="img"></div>
                    <h3 class="text">提升企业形象及知名度</h3>
                </li>
                <li>
                    <div class="img"></div>
                    <h3 class="text">提升企业竞争力</h3>
                </li>
                <li>
                    <div class="img"></div>
                    <h3 class="text">扩大企业市场份</h3>
                </li>
            </ul>
        </div>
        <div class="advantage clearfix">
            ...
            <ul class="custom-list container clearfix">
                <li>
                    <p class="icon"></p>
                    <p class="title">页面丰富简洁</p>
                    <p class="text">使用H5建站，不仅可以大胆使用动画、视频等，且无需担心浏览不顺畅的问题，同时让页面显得更加丰富，又能保证其整洁性。</p>
                </li>
                <li>
                    <p class="icon"></p>
                    <p class="title">有利于网站优化</p>
                    <p class="text">H5技术所使用的代码程序相对于旧时的编程来说要简洁得多，且运用多媒体的情况下，对搜索引擎的抓取也是非常友好的，因此网站优化起来</p>
                </li>
                <li>
                    <p class="icon"></p>
                    <p class="title">提高用户体验</p>
                    <p class="text">H5的出现，改善了网页内容被插件束缚的局面，创造了丰富多彩的网站，满足了用户视觉上的审美要求，且能够保证网站的加载速度</p>
                </li>
                <li>
                    <p class="icon"></p>
                    <p class="title">增加用户流量</p>
                    <p class="text">H5网站的建设，轻松拓展了用户浏览渠道，实现了网站跨平台的运用，尤其移动设备的多样化，包括各种屏幕大小的手机，平板等等。</p>
                </li>
            </ul>
        </div>
    </div>
...
">首页</a>
                ...
                <li>
                    <a href="./appdev.html" onClick="scrollTo(0,0);
">App开发</a>
                </li>
                <li>
                    <a href="./store.html" onClick="scrollTo(0,0);
">商城开发</a>
                </li>
                <li>
                    <a href="./game.html" onClick="scrollTo(0,0);
">游戏开发</a>
                </li>
                <li>
                    <a href="./applet.html" onClick="scrollTo(0,0);
">小程序开发</a>
                </li>
                <li>
                    <a href="./h5.html" onClick="scrollTo(0,0);
">H5建站</a>
                </li>
                <li>
                    <a href="./zhidxcom.html" onClick="scrollTo(0,0);
">公众号开发</a>
                </li>
                <li>
                    <a href="./iot.html" onClick="scrollTo(0,0);
">物联网</a>
                </li>
                <li>
                    <a href="./smarthome.html" onClick="scrollTo(0,0);
">智能家居开发</a>
                </li>
                <li>
                    <a href="./contactus.html" onClick="scrollTo(0,0);
">联系我们</a>
                </li>
            </ul>
            <!-- 底部信息 -->
