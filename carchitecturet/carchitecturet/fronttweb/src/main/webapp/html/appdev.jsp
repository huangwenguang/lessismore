...
<body>
        ...
        <div class="header">
            <div class="container">
                ...
                <ul class="nav">
                    ...
                    <li><a class="active" href="./appdev.jsp">APP开发<span></span></a></li>
    ...
    <div>
        ...
        <div class="app-dev">
            ...
            <div class="app-introduce container">
                ...
                <div class="dev-icon clearfix">
                    <div class="ios fl">
                        <div class="icon"></div>
                        <div class="text">ios应用开发</div>
                    </div>
                    <div class="android fl">
                        <div class="icon"></div>
                        <div class="text">android应用开发</div>
                    </div>
                </div>
            </div>
            <!--  服务特色-->
            <div class="feature container">
                <ul class="feature-nav clearfix">
                    <li>
                        <div class="icon fl"></div>
                        <div class="explain fr">
                            <h4>需求分析</h4>
                            <p>一对一专属顾问，倾听客户需求，了解用户使用环境和操作流程。</p>
                        </div>
                    </li>
                    <li>
                        <div class="icon fl"></div>
                        <div class="explain fr">
                            <h4>交互设计</h4>
                            <p>从用户的角度思考，模拟用户行为，色彩及平面元素设定，结构和布局规范确认</p>
                        </div>
                    </li>
                    <li>
                        <div class="icon fl"></div>
                        <div class="explain fr">
                            <h4>产品测试</h4>
                            <p>完成App（ios和android）、后台、接口以及模拟日常应用等测试，并生成相应的测试bug文档</p>
                        </div>
                    </li>
                    <li>
                        <div class="icon fl"></div>
                        <div class="explain fr">
                            <h4>项目策划</h4>
                            <p>头脑风景交互情景模拟原型，设计系统整体架构，定义基本规范</p>
                        </div>
                    </li>
                    <li>
                        <div class="icon fl"></div>
                        <div class="explain fr">
                            <h4>技术开发</h4>
                            <p>根据负责人设计的框架，完成各个功能模块的开发，提供ios，安卓多平台开发</p>
                        </div>
                    </li>
                    <li>
                        <div class="icon fl"></div>
                        <div class="explain fr">
                            <h4>更新&维护</h4>
                            <p>分析测试数据，找出核心问题所在且提出有效的解决方案，版本迭代，修改调整，规范完善</p>
                        </div>
                    </li>
                </ul>
            </div>
