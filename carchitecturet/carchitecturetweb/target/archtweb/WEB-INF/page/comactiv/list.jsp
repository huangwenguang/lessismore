...
<body>
	<form action="${ctx }/comact/list.do" id="submit-form">
	<div class="page-body">
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					<div class="widget-header ">
						<span class="widget-caption">公司活动</span>
					</div>
					<%-- <div class="widget-body">
                      ...
                      <div class="table-toolbar">
						<a id="editabledatatable_new" href="${ctx }/comact/add.do"
							class="btn btn-default">添加活动信息</a>
					</div>
...
<script src="${ctx }/js/comact/list.js"></script>
</body>
