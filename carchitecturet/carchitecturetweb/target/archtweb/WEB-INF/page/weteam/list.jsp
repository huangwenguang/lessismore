...
<body>
	<form action="${ctx }/weTeams/list.do" id="submit-form">
	<div class="page-body">
		<div class="row">
				...
				<div class="widget">
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<tbody>								
                               <tr>
	                                <td>${bean.id }</td>                                    
									<td>${bean.content }</td>									                           
                             		<td><a href="${ctx }/weTeams/editWe.do?id=${bean.id}" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>编辑</a>
	                                 </td>                                                             
                                 </tr>       	  
							</tbody>
						</table>	
					...
					<%-- <div class="widget-body">
                      ...
                      <div class="table-toolbar">
						<a id="editabledatatable_new" href="${ctx }/weTeams/add.do?id=${bean.id }"
							class="btn btn-default">添加团队图片</a>						
					</div>
						<table class="table table-striped table-bordered table-hover"
							id="simpledatatable">
							<thead>
...
<script src="${ctx }/js/weteam/list.js"></script>
</body>
