...
<body>
	<form action="${ctx }/tecCoope/list.do" id="submit-form">
	<div class="page-body">
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					<div class="widget-header ">
						<span class="widget-caption">技术外派</span>
					</div>
					<%-- <div class="widget-body">
                      ...
                      <div class="table-toolbar">
						<a id="editabledatatable_new" href="${ctx }/tecCoope/add.do"
							class="btn btn-default">添加公司信息</a>
					</div>
							...
							<tbody>
								 ...
								 <tr>
                                      	   <%--  <input type="hidden" name="id" value="${"lottery.openTime }"/> --%>
				                                 ...
				                                 <td>${item.id }</td>                                  	 
			                                     <td><a href="${ctx }/typePic/list.do?foid=${item.id }">${item.companyName }</a></td>  
			                                     <td>
...
<script src="${ctx }/js/tecoope/list.js"></script>
</body>
