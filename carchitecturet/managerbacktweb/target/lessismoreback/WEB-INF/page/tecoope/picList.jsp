...
<body>
	<form action="${ctx }/typePic/list.do?foid=${foid}" id="submit-form">
	<input type="hidden" id="kkk" value="${foid}">
	<div class="page-body">
		<div class="row">
				...
				<div class="widget">
					...
					<%-- <div class="widget-body">
                      ...
                      <div class="table-toolbar">
						<a id="editabledatatable_new" href="${ctx }/typePic/add.do?id=${foid}"
							class="btn btn-default">添加公司图片</a>
					</div>
							...
							<tbody>
								 ...
								 <tr>
                                      	   <%--  <input type="hidden" name="id" value="${"lottery.openTime }"/> --%>
                                            	...
                                            	<td>
		                                      	  	<a href="javascript:void(0)" class="btn btn-info btn-xs edit" onclick="edit('user','${item.id}','${item.forId}')"><i class="fa fa-edit"></i>编辑</a>
...
<script src="${ctx }/js/tecoope/picList.js"></script>
</body>
