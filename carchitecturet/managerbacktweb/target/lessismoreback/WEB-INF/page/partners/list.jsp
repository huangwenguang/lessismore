...
<body>
	<form action="${ctx }/partners/list.do" id="submit-form">
	<div class="page-body">
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					<div class="widget-header ">
						<span class="widget-caption">合作企业</span>
					</div>
					<div class="widget-body">
                      ...
                      <div class="table-toolbar">
						<a id="editabledatatable_new" href="${ctx }/partners/add.do"
							class="btn btn-default">添加企业信息</a>
					</div>
...
<script src="${ctx }/js/partners/list.js"></script>
</body>
