        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                ...
                <div class="widget-body">                	                                           
                    <form id="saveOrUpdate" class="form-horizontal form-bordered" role="form" enctype="multipart/form-data" method="post" action="${ ctx}/company/editWeDo.do">
                        	...
                        	<div class="form-group">
	                        	...
	                        	<div class="col-sm-10">
	                        		<input type="text" class="form-control" id="contentpic" name="contentpic" 
	                        				placeholder="公司简介" data-bv-notempty="true" data-bv-notempty-message="公司简介不能为空" />
	                        	</div>
                    		...
                    		<div class="form-group">
	                        	...
	                        	<div class="col-sm-10">
	                        		<%-- <input type="text" class="form-control" id="content" name="content"  value = "${bean.content}"
	                        			...
	                        			<textarea rows="7" cols="80" id="content" name="content"  value = "${bean.content}" placeholder="公司简介" data-bv-notempty="true" data-bv-notempty-message="公司简介不能为空">${bean.content}</textarea>
	                        	</div>
                        	</div>                          	                
                        </c:if>
                        <div class="form-group">
