        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                ...
                <div class="widget-body">                	                                           
                    <form id="saveOrUpdate" class="form-horizontal form-bordered" role="form" enctype="multipart/form-data" method="post" action="${ ctx}/comact/saveDo.do">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a class="btn btn-palegreen" href="${ctx}/comact/list.do">返回</a>
...
<script>
	...
	var save =function(){
		...
		$("#saveOrUpdate").ajaxSubmit(function(result) {			
			  if(result.status == 1){
				  window.location.href = '${ctx}' + "/comact/list.do";
			  }else{
